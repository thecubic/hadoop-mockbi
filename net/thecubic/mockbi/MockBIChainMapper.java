...
/* MockBISummaryKey(smaller_bin), number_summary -> MockBISummaryKey(larger_bin), number_summary */
    public class MockBIChainMapper extends TableMapper<MockBISummaryKey, MapWritable> {
